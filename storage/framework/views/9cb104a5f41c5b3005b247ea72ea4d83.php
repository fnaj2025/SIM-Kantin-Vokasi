...
<div class="report-stats">
    <div class="report-card">
        ...
        <div class="report-val">Rp <?php echo e(number_format($totalRevenue,0,',','.')); ?></div>
    </div>
    <div class="report-card">
        ...
        <div class="report-val"><?php echo e($totalOrders); ?></div>
    </div>
    <div class="report-card">
        ...
        <div class="report-val"><?php echo e($completedOrders); ?></div>
    </div>
</div>
...
<div class="panel-premium">
    ...
    <div class="ai-grid">
        ...
        <div class="ai-insight-box">
            ...
            <div class="ai-list">
                <?php $invAgent = (new \App\Services\Agents\InventoryIntelligenceAgent())->analyze(); ?>
                <?php $__empty_1 = true; $__currentLoopData = $invAgent['alerts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="ai-item">
                        <div class="ai-dot" style="background:#FEE2E2; color:#EF4444">!</div>
                        <div class="ai-text"><?php echo e($alert['message']); ?></div>
                    </div>
                ...
                <?php endif; ?>
                <?php $__currentLoopData = $invAgent['recommendations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ai-item">
                        <div class="ai-dot" style="background:#EFF6FF; color:#3B82F6">i</div>
                        <div class="ai-text"><?php echo e($rec); ?></div>
                    </div>
        ...
        <div class="ai-insight-box">
            ...
            <div class="ai-list">
                <?php $kitAgent = (new \App\Services\Agents\KitchenWorkflowAgent())->analyze(); ?>
                <?php $__empty_1 = true; $__currentLoopData = $kitAgent['alerts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="ai-item">
                        <div class="ai-dot" style="background:#FEE2E2; color:#EF4444">!</div>
                        <div class="ai-text"><?php echo e($alert['message']); ?></div>
                    </div>
                ...
                <?php endif; ?>
                <?php $__currentLoopData = $kitAgent['recommendations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ai-item">
                        <div class="ai-dot" style="background:#EFF6FF; color:#3B82F6">i</div>
                        <div class="ai-text"><?php echo e($rec); ?></div>
                    </div>
        ...
        <div class="ai-insight-box">
            ...
            <div class="ai-list">
                <?php $finAgent = (new \App\Services\Agents\FinancialMonitoringAgent())->analyze(); ?>
                <?php $__empty_1 = true; $__currentLoopData = $finAgent['alerts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="ai-item">
        ...
        <div class="ai-insight-box">
            ...
            <div class="ai-list">
                <?php $opsAgent = (new \App\Services\Agents\OperationalAnalyticsAgent())->analyze(); ?>
                <?php $__empty_1 = true; $__currentLoopData = $opsAgent['insights']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="ai-item">
                        <div class="ai-dot" style="background:#EFF6FF; color:#3B82F6">i</div>
                        <div class="ai-text"><?php echo e($ins['message']); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="ai-item">
...
<?php if(!empty($opsAgent['hourly_data'])): ?>
<div class="panel-premium">
    ...
    <?php $maxVal = max(array_column($opsAgent['hourly_data'], 'count') ?: [1]); ?>
    <div class="chart-container">
        <?php $__currentLoopData = $opsAgent['hourly_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $h = $maxVal > 0 ? max(10, round($point['count'] / $maxVal * 180)) : 10; ?>
        <div class="bar-wrapper">
            <div class="bar-value" style="opacity:<?php echo e($point['count']>0?1:0); ?>"><?php echo e($point['count']); ?></div>
            <div class="bar-fill <?php echo e($point['count']==$maxVal && $maxVal>0 ? 'active' : ''); ?>" style="height:<?php echo e($h); ?>px"></div>
            <div class="bar-label"><?php echo e($point['hour']); ?></div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.internal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KANTINVOKASI\resources\views/internal/reports.blade.php ENDPATH**/ ?>