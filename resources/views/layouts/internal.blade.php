...
<head>
    ...
    <title>{{ config('app.name') }} Internal — @yield('title', 'Dashboard')</title>
...
<div class="main-wrapper">
    <header class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">KantinVokasi &rsaquo; @yield('title', 'Dashboard')</div>
        </div>
        <div class="topbar-spacer"></div>
        <span class="topbar-clock">{{ now()->isoFormat('ddd, D MMM YYYY · HH:mm') }}</span>
