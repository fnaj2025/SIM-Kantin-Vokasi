...
<body>
    <div class="login-card">
        ...
        <form action="{{ route('internal.login') }}" method="POST">
            @csrf
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" name="email" class="form-input" value="{{ old('email') }}" required autofocus placeholder="nama@kantinvokasi.com">
                </div>
                @error('email')<div style="color: #ef4444; font-size: 0.75rem; margin-top: 0.5rem; font-weight: 600;">{{ $message }}</div>@enderror
            </div>
